...
You can make a numbered list by using numbers.
...
[LaTeX](http://www.latex-project.org/), you can use `$ $` and `$$ $$` to insert math equations.
...
knitr::opts_chunk$set(fig.path="fig_output/", message=FALSE, warning=FALSE,
...
the standard place but just with names that begin with `fig_output`.
...
> ## Exercise 5
>
> Finish up by creating your own report!
> Make sure you are loading the data, then add a plot.
> Either improve one of the plots generated in the ggplot section or create a
...
> for inspiration.
> Add some markdown text explaining how to interpret your plot and knit it as an html document.
{: .challenge}
